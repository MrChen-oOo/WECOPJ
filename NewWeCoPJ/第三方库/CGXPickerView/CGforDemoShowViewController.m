//
//  CGforDemoShowViewController.m
//  瑞能云
//
//  Created by sky on 2019/2/20.
//  Copyright © 2019年 tuolve. All rights reserved.
//

#import "CGforDemoShowViewController.h"
#import <Foundation/Foundation.h>
#import "CGXPickerView.h"
#import <UIKit/UIKit.h>

@interface CGforDemoShowViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation CGforDemoShowViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([title isEqualToString:@"出生年月选择器"]) {
        ...
        [fmt setCalendar:[NSCalendar calendarWithIdentifier:NSCalendarIdentifierGregorian]];
