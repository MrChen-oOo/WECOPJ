...
- (UIPickerView *)pickerView {
    if (!_pickerView) {
        ...
        [_pickerView setValue:COLOR(102, 102, 102, 1) forKey:@"textColor"];//COLOR(5,142,240,1)
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view {
    ...
    for(UIView *singleLine in pickerView.subviews)
    {
        ...
        {
            singleLine.backgroundColor = COLOR(102, 102, 102, 1);//COLOR(5,142,240,1);
        }
    }
...
//        [pickerLabel setBackgroundColor:[UIColor whiteColor]];
        ...
        [pickerLabel setTextColor:COLOR(102, 102, 102, 1)];//COLOR(5,142,240,1)
    }
