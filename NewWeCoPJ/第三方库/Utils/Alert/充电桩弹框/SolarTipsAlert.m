...
//  charge
//
//  Created by BQ123 on 2018/11/21.
//  Copyright © 2018 hshao. All rights reserved.
//

#import "SolarTipsAlert.h"// 充电桩solar限制功能弹框
...
- (void)initUI{
    ...
    // 标题
    UILabel *titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(paddingLF, 2*paddingLF, bouncedView_Width*XLscaleW-2*paddingLF, 15*XLscaleH)];
    ...
    UILabel *titleLabel2 = [[UILabel alloc]initWithFrame:CGRectMake(paddingLF, CGRectGetMaxY(titleLabel.frame)+3*XLscaleH, bouncedView_Width*XLscaleW-2*paddingLF, 15*XLscaleH)];
