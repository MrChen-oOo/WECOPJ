...
@interface InveterDeviceView()<UITableViewDelegate,UITableViewDataSource>
...
@implementation InveterDeviceView
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView {
    return self.inveterVM.infoModel.inveterKeyOneArray.count;
}

-(NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return self.inveterVM.infoModel.inveterKeyOneArray[section].count;
}


- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    return  indexPath.row == 0 || indexPath.row == (self.inveterVM.infoModel.inveterKeyOneArray[indexPath.section].count - 1) ? 60 : 40; // 60
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    sectionName.text = self.inveterVM.infoModel.inveterSectionOneArray[section];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell setCellUIWithKey:self.inveterVM.infoModel.inveterKeyOneArray[indexPath.section][indexPath.row]
                     value:self.inveterVM.infoModel.inveterValueOneArray[indexPath.section][indexPath.row]
                    isLast:indexPath.row == (self.inveterVM.infoModel.inveterKeyOneArray[indexPath.section].count - 1) ? YES : NO
                   isFirst:indexPath.row == 0 ? YES : NO
                 isSegment:NO
                      unit:[self.inveterVM.infoModel.inveterUnitOneArray[indexPath.section][indexPath.row] intValue] typeNum:4];
    return cell;
}
